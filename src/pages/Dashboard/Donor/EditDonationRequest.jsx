...
const EditDonationRequest = () => {
  ...
  const handleUpdate = () => {
    axiosSecure
      ...
      .catch((err) => {
        Swal.fire("Error", "There was an issue updating the donation request.", "error");
      });
  };
  ...
  return (
    <div className="p-6 mx-auto mt-10 bg-red-50 rounded-lg shadow-lg">
      <h2 className="text-3xl font-bold text-center text-red-700 mb-6">Edit Your Blood Donation Request</h2>
      <div className="bg-white p-6 rounded-lg shadow-md">
        <div className="mb-4">
          <label className="block text-red-700 font-semibold">Recipient Name</label>
          <input
            type="text"
            name="recipientName"
        ...
        <div className="mb-4">
          <label className="block text-red-700 font-semibold">Blood Group</label>
          <select
            name="bloodGroup"
        ...
        <div className="mb-4">
          <label className="block text-red-700 font-semibold">Donation Date</label>
          <input
            type="date"
            name="donationDate"
        ...
        <div className="mb-4">
          <label className="block text-red-700 font-semibold">Donation Time</label>
          <input
            type="time"
            name="donationTime"
