			...
			<section className="py-16">
				<div className="max-w-6xl mx-auto px-4">
					...
					<p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
						Discover how you can easily donate and save lives with these
						essential features.
					</p>
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
						{[
							...
							{
								icon: (
									<FaCalendarCheck className="text-red-600 text-5xl mb-4" />
								),
				...
				<div className="max-w-7xl mx-auto px-4">
					...
					<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
						{[
							{
								image:
									"https://www.clarksvilleonline.com/wp-content/uploads/2018/07/RedCross_Donor4.jpg",
								title: "Register",
								description:
									"Sign up using our simple online registration form.",
							},
							{
								image:
							...
							{
								image:
									"https://i.ibb.co.com/2YP9nWrJ/nguy-n-hi-p-2r-NHli-X6-XHk-unsplash.jpg",
							...
							{
								image:
									"https://www.amchamvietnam.com/events/amcham-world-blood-donor-days-2019/37245641_873802789483611_1205637207348477952_o/",
							...
							>
								...
								<div className="p-6">
									...
									<Link to={"/blog"}>
										<Button className="mt-10 bg-red-600 hover:bg-red-700 text-white py-2 px-4 rounded-full ">
											Learn More
										</Button>
									</Link>
								</div>
