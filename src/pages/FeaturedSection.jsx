...
const FeaturedSection = () => {
	const testimonials = [
		...
		},
		{
			...
			role: "Frequent Donor",
			image:
				"https://thumbs.dreamstime.com/b/fin-souriante-urbaine-de-jeune-homme-avec-l-espace-de-copie-93583763.jpg",
			rating: 5,
			message:
			...
			<div className="max-w-7xl mx-auto text-center px-4">
				...
				>
					{testimonials.map((testimonial, index) => (
						...
						>
							<div className="bg-white p-8 rounded-lg border  max-w-2xl h-64 mx-auto shadow-lg scale-105 transition-transform duration-300">
