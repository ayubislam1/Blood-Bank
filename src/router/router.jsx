				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Welcome to the Blood Donation platform."
							/>
						</Helmet>
						<Home />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Create an account to join the Blood Donation platform."
							/>
						</Helmet>
						<Register />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="View all blood donation requests."
							/>
						</Helmet>
					...
					<PrivateRouter>
						<>
							<Helmet>
								...
								<meta
									name="description"
									content="View details of a specific blood donation request."
								/>
							</Helmet>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Search for blood donation requests and resources."
							/>
						</Helmet>
						<SearchPage />
					</>
					...
					<PrivateRouter>
						<>
							<Helmet>
								...
								<meta
									name="description"
									content="Support our blood donation platform through funding."
								/>
							</Helmet>
							<FundingPage />
						</>
		...
		children: [
			{
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="View and update your profile details."
							/>
						</Helmet>
						<ProfilePage />
					</>
				...
				loader: async ({ params }) =>
					await fetch(
						`https://assignment-12-backend-one.vercel.app/all-users/${params.email}`
					),
			},
			{
					...
					<AdminRoute>
						<>
							<Helmet>
								...
								<meta
									name="description"
									content="Manage the Blood Donation platform."
								/>
							</Helmet>
							<AdminDashboard />
						</>
					...
					<AdminRoute>
						<>
							<Helmet>
								...
								<meta
									name="description"
									content="View and manage all registered users."
								/>
							</Helmet>
							<AllUsersPage />
						</>
					...
					<AdminRoute>
						<>
							<Helmet>
								...
								<meta
									name="description"
									content="View and manage all blood donation requests."
								/>
							</Helmet>
							<AllDonationRequests />
						</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Manage content for the Blood Donation platform."
							/>
						</Helmet>
						<ContentManagement />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Create and publish a new blog post."
							/>
						</Helmet>
						<AddBlog />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Welcome to your donor dashboard."
							/>
						</Helmet>
						<DonorHome />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="View your blood donation requests."
							/>
						</Helmet>
						<MyDonationRequests />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Submit a new blood donation request."
							/>
						</Helmet>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Edit your blood donation request details."
							/>
						</Helmet>
						<EditDonationRequest />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="View the details of your blood donation request."
							/>
						</Helmet>
						<ViewDonationRequest />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="Welcome to your volunteer dashboard."
							/>
						</Helmet>
						<VolunteerDashboard />
					</>
				...
				element: (
					<>
						<Helmet>
							...
							<meta
								name="description"
								content="View all donation requests assigned to you."
							/>
						</Helmet>
